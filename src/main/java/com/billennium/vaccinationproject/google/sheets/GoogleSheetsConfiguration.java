...
public class GoogleSheetsConfiguration {
    ...
    static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        InputStream inputStream = GoogleSheetsService.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (inputStream == null) {
        ...
        return new AuthorizationCodeInstalledApp(flow, receiver).authorize("Whatever");
    }
}
